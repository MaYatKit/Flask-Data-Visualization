    ...
    XHR.onreadystatechange = function () {
        ...
        if (XHR.readyState === 4 && XHR.status === 200) {
            if (XHR.responseText) {
                ...
                let mt_dates = mts.split(",")[0];
                let mt_values = mts.split(",")[1];

                let ct_dates = cts.split(",")[0];
                let ct_values = cts.split(",")[1];

                let rok_dates = roks.split(",")[0];
                let rok_values = roks.split(",")[1];

                let rol_dates = rols.split(",")[0];
                let rol_values = rols.split(",")[1];
